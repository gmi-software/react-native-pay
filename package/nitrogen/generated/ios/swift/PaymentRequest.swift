...
public extension PaymentRequest {
   ...
   */
  init(applePayMerchantIdentifier: String?, merchantName: String?, countryCode: String, currencyCode: String, paymentItems: [PaymentItem], merchantCapabilities: [String], supportedNetworks: [String], shippingType: String?, shippingMethods: [PaymentItem]?, billingContactRequired: Bool?, shippingContactRequired: Bool?, googlePayMerchantId: String?, googlePayEnvironment: GooglePayEnvironment?, googlePayGateway: String?, googlePayGatewayMerchantId: String?) {
    self.init({ () -> bridge.std__optional_std__string_ in
      if let __unwrappedValue = applePayMerchantIdentifier {
      ...
      if let __unwrappedValue = googlePayMerchantId {
        return bridge.create_std__optional_std__string_(std.string(__unwrappedValue))
      } else {
        return .init()
      }
  ...
  var applePayMerchantIdentifier: String? {
    ...
    get {
      return { () -> String? in
        if bridge.has_value_std__optional_std__string_(self.__applePayMerchantIdentifier) {
          let __unwrapped = bridge.get_std__optional_std__string_(self.__applePayMerchantIdentifier)
    ...
    @inline(__always)
    set {
      self.__applePayMerchantIdentifier = { () -> bridge.std__optional_std__string_ in
  ...
  var googlePayMerchantId: String? {
    @inline(__always)
    get {
      return { () -> String? in
        if bridge.has_value_std__optional_std__string_(self.__googlePayMerchantId) {
          let __unwrapped = bridge.get_std__optional_std__string_(self.__googlePayMerchantId)
          return String(__unwrapped)
        } else {
          return nil
        }
    ...
    @inline(__always)
    set {
      self.__googlePayMerchantId = { () -> bridge.std__optional_std__string_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_std__string_(std.string(__unwrappedValue))
        } else {
          return .init()
