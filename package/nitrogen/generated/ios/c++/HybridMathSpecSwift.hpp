...
namespace margelo::nitro::pay {
  ...
  public:
    ...
    explicit HybridMathSpecSwift(const NitroPay::HybridMathSpec_cxx& swiftPart):
      HybridObject(HybridMathSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroPay::HybridMathSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroPay::HybridMathSpec_cxx _swiftPart;
  };
